...
{
    public class SPalabraToken : IToken
    {
        public ResultadoTokenizador verificarToken(Entrada e, string tok)
        {
            ...
            if (tok == "s" || tok == "S")
            {
                ...
                if (tokCompleto.Equals("static", StringComparison.OrdinalIgnoreCase))
                {
                    var t = new Token
                    {
                        Lexema = tokCompleto,
                ...
                else if (tokCompleto.Equals("set", StringComparison.OrdinalIgnoreCase))
                {
                    var t = new Token
                    {
                        Lexema = tokCompleto,
