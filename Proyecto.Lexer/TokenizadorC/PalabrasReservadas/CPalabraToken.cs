...
{
    public class CPalabraToken : IToken
    {
        public ResultadoTokenizador verificarToken(Entrada e, string tok)
        {
            ...
            if (tok == "c" || tok == "C")
            {
                ...
                if (tokCompleto.Equals("class", StringComparison.OrdinalIgnoreCase))
                {
                    var t = new Token
                    {
                        Lexema = tokCompleto,
                ...
                else if (tokCompleto.Equals("console", StringComparison.OrdinalIgnoreCase))
                {
                    var t = new Token
                    {
                        Lexema = tokCompleto,
